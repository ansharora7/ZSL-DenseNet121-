Same as 7
Change: Vae Reduced one layer , 1024->256->128
...
class Autoencoder(nn.Module):
    def __init__(self,D_in,H2,latent_dim):
...
#         # Decoder
        ...
        self.linear6=nn.Linear(H2,D_in)
    ...
    def encode(self, x):
        ...
        lin3 = self.relu(self.lin_bn3(self.linear3(lin1)))
    ...
    def decode(self, z):
        ...
        return self.lin_bn6(self.linear6(lin4))
...
class VAE:
    def __init__(self):
        ...
        self.model = Autoencoder(self.D_in, self.H2, self.latent_dim).to(device)
